...
public class RespondHelpActivity extends NMapActivity implements OnMapStateChangeListener, OnCalloutOverlayListener, LocationListener
{ 
	private String message = "[Wekimi요청대응]";
