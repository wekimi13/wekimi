...
public class BeforeRespondActivity extends FunctionActivity
{
	...
	String pName;
     ...
     public void onCreate(Bundle savedInstanceState)
     {
           ...
           setContentView(R.layout.beforeres);
           ...
           Button toRespond = (Button)findViewById(R.id.toRespond);
           
           toRespond.setOnClickListener(new Button.OnClickListener()
           {
        	   public void onClick(View v)
        	   {
        		   Intent intent = new Intent(BeforeRespondActivity.this, RespondHelpActivity.class);
